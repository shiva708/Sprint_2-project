...
def dates(context):
    ...
    context.driver.find_element(by=By.XPATH,value="/html/body/div[1]/div[1]/main/div[3]/div[2]/div/div[3]/div/div/form/div[4]/div/div/div[2]/div/div[3]/div/div/div/div[1]/table/tbody/tr[4]/td[5]/time/button/span").click()  #
    context.driver.find_element(by=By.XPATH,value="/html/body/div[1]/div[1]/main/div[3]/div[2]/div/div[3]/div/div/form/div[4]/div/div/div[2]/div/div[3]/div/div/div/div[1]/table/tbody/tr[5]/td[7]/time/button/span").click()  #


@given(u'select the No of adults and childs and apply')
